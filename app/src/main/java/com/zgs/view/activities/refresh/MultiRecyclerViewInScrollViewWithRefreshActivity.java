...
public class MultiRecyclerViewInScrollViewWithRefreshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_recycler_view_in_scroll_view_with_refresh);
